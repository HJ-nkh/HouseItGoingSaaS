...
param(
	...
	[string]$StackName = 'house-it-going/run-simulation',  # ECR repository path
	[string]$FunctionName = 'run-simulation-lambda'  # Optional Lambda function name to update after push (leave empty to skip update
)
