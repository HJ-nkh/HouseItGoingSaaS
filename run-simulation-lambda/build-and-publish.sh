...
# Tag the image
docker tag run-simulation:latest $AWS_ACCOUNT_ID.dkr.ecr.eu-north-1.amazonaws.com/$STACK_NAME-ecr-repository:run-simulation-latest

# Push the image to ECR
docker push $AWS_ACCOUNT_ID.dkr.ecr.eu-north-1.amazonaws.com/$STACK_NAME-ecr-repository:run-simulation-latest
